...
import numpy as np
import copy
from Data.Human36M.skeleton import Skeleton
from Data.Human36M.mocap_dataset import MocapDataset
from Data.Human36M.camera import normalize_screen_coordinates, image_coordinates
...
skeleton_group = [[2, 5, 8], [3, 4, 7], [0], [1], [1, 6, 7], [0], [4], # Pelvis, Right-Leg, Left-Leg
                  [1, 4, 9, 11, 14], [0, 10, 12, 15], [7, 11, 14], [8],               # Center-Line
                  [7, 9, 13, 14], [8], [11], [7, 9, 11, 16], [8], [14]] # Left-Arm, Right-Arm

skeleton_graph_ext_1 = [[2, 5, 8], [3, 4, 7], [0], [1], [1, 6, 7], [0], [4],    # Pelvis, Right-Leg, Left-Leg
                        [1, 4, 9, 11, 14], [0, 10, 12, 15], [7, 11, 14], [8],   # Center-Line
                        [7, 9, 13, 14], [8], [11], [7, 9, 11, 16], [8], [14]]   # Left-Arm, Right-Arm

skeleton_graph_ext_2 = [[3, 6, 9, 11, 14], [5, 8], [7, 4], [0], [2, 8], [1, 7], [0],    # Pelvis, Right-Leg, Left-Leg
                        [2, 5, 10, 12, 15], [13, 16], [0, 12, 15], [7, 11, 14],         # Center-Line
                        [0, 10, 15], [7, 9], [8], [0, 10, 12], [7, 9], [8]]             # Left-Arm, Right-Arm

skeleton_graph_ext_3 = [[10, 12, 15], [6, 9, 11, 14], [5, 8], [4, 7], [3, 9, 11, 14], [2, 8], [1, 7],    # Pelvis, Right-Leg, Left-Leg
                        [3, 6, 13, 16], [2, 5], [1, 4, 13, 16], [0, 12, 15],   # Center-Line
                        [1, 4, 16], [0, 10, 15], [7, 9], [1, 4, 13], [0, 10, 12], [7, 9]]   # Left-Arm, Right-Arm

skeleton_graph_ext_4 = [[13, 16], [10, 12, 15], [6, 9, 11, 14], [5, 8], [10, 12, 15], [3, 9, 11, 14], [2, 8],    # Pelvis, Right-Leg, Left-Leg
                        [], [3, 6], [2, 5], [1, 4, 13, 16],         # Center-Line
                        [2, 5], [1, 4, 16], [0, 10, 15], [2, 5], [1, 4, 13], [0, 10, 12]]             # Left-Arm, Right-Arm
...
class Human36mDataset(MocapDataset):
    def __init__(self, path, remove_static_joints=True):
        ...
        if remove_static_joints:
            ...
            # Set joints graph
            self._skeleton._joints_graph_ext_1 = skeleton_graph_ext_1
            self._skeleton._joints_graph_ext_2 = skeleton_graph_ext_2
            self._skeleton._joints_graph_ext_3 = skeleton_graph_ext_3
            self._skeleton._joints_graph_ext_4 = skeleton_graph_ext_4
